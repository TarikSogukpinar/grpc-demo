...
type WeatherServiceClient interface {
	...
	GetWeatherStream(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WeatherResponse], error)
}
...
func (c *weatherServiceClient) GetWeatherStream(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WeatherResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WeatherService_GetWeatherStreamClient = grpc.ServerStreamingClient[WeatherResponse]
...
type WeatherServiceServer interface {
	...
	GetWeatherStream(*WeatherRequest, grpc.ServerStreamingServer[WeatherResponse]) error
...
func (UnimplementedWeatherServiceServer) GetWeatherStream(*WeatherRequest, grpc.ServerStreamingServer[WeatherResponse]) error {
...
func _WeatherService_GetWeatherStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(WeatherServiceServer).GetWeatherStream(m, &grpc.GenericServerStream[WeatherRequest, WeatherResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type WeatherService_GetWeatherStreamServer = grpc.ServerStreamingServer[WeatherResponse]
